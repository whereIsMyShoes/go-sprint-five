...
func (w Walking) Calories() float64 {
	...
	calories := ((CaloriesWeightMultiplier*w.Weight + (math.Pow((w.meanSpeed())*KmHInMsec, 2)/height)*CaloriesSpeedHeightMultiplier*w.Weight) * float64(w.Duration.Hours()) * MinInHours)
	return calories
}
